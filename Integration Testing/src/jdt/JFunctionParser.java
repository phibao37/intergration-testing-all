...
public class JFunctionParser implements IFunctionParser {
	...
	@Override
	public IStatement[] parseFunction(IFunction fn, boolean subCondition, IProject project) {
		this.fn = fn;
		...
		visitBlock((Block) fn.getBody(), BEGIN, END, null, null);
