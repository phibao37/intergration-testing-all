...
public class TableLayoutConstraints implements TableLayoutConstants, Cloneable
{
...
public String toString ()
{
	...
	@Override
	public TableLayoutConstraints clone()  {
		try {
			return (TableLayoutConstraints) super.clone();
